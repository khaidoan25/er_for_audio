...
if __name__ == "__main__":
    ...
    with h5py.File("dataset_RGB_1.h5", "w") as hf:
    ...
    with h5py.File("dataset_RGB_2.h5", "w") as hf:
    ...
    with h5py.File("dataset_RGB_3.h5", "w") as hf:
    ...
    with h5py.File("test_RGB.h5", "w") as hf:
